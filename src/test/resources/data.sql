...
VALUES (100020, 'LECTURE_TIME', 100002, 100016, 100026, '2022-01-25'),    -- 12
       ...
       (100020, 'LECTURE_TIME', 100002, 100016, 100026, '2022-01-25'),    -- 13
       (100021, 'LECTURE_TIME', 100003, 100017, 100027, '2022-01-25'),
       (100022, 'LECTURE_TIME', 100004, 100018, 100028, '2022-01-25'),
       (100023, 'LECTURE_TIME', 100005, 100019, 100029, '2022-01-25'),
       (100020, 'LECTURE_TIME', 100002, 100016, 100026, '2022-01-25'),    -- 14
       (100021, 'LECTURE_TIME', 100003, 100017, 100027, '2022-01-25'),
       (100022, 'LECTURE_TIME', 100004, 100018, 100028, '2022-01-25'),
       (100023, 'LECTURE_TIME', 100005, 100019, 100029, '2022-01-25'),
       (100020, 'LECTURE_TIME', 100002, 100016, 100026, '2022-01-25'),    -- 15
       (100021, 'LECTURE_TIME', 100003, 100017, 100027, '2022-01-25'),
       (100022, 'LECTURE_TIME', 100004, 100018, 100028, '2022-01-25'),
       (100023, 'LECTURE_TIME', 100005, 100019, 100029, '2022-01-25');

INSERT INTO lecture(discipline_id, lecture_type, lecture_hall_id, educator_id, student_group_id)
VALUES (100020, 'LECTURE_TIME', 100002, 100016, 100026), -- 12
       (100021, 'LECTURE_TIME', 100003, 100017, 100027),
       (100022, 'LECTURE_TIME', 100004, 100018, 100028),
       (100023, 'LECTURE_TIME', 100005, 100019, 100029),
       (100020, 'LECTURE_TIME', 100002, 100016, 100026), -- 13
       (100021, 'LECTURE_TIME', 100003, 100017, 100027),
       (100022, 'LECTURE_TIME', 100004, 100018, 100028),
       (100023, 'LECTURE_TIME', 100005, 100019, 100029),
       (100020, 'LECTURE_TIME', 100002, 100016, 100026), -- 14
       (100021, 'LECTURE_TIME', 100003, 100017, 100027),
       (100022, 'LECTURE_TIME', 100004, 100018, 100028),
       (100023, 'LECTURE_TIME', 100005, 100019, 100029),
       (100020, 'LECTURE_TIME', 100002, 100016, 100026), -- 15
       (100021, 'LECTURE_TIME', 100003, 100017, 100027),
       (100022, 'LECTURE_TIME', 100004, 100018, 100028),
       (100023, 'LECTURE_TIME', 100005, 100019, 100029);

INSERT INTO users(id, login, password, enabled)
VALUES (100030, 'student', '$2a$10$Sz/ioVIcYZExKdrK/jWI.OlF2BY2Xqo4Ekr482IGciLPgZCZuxY0.', TRUE),
       (100012, 'dispatcher', '$2a$10$.w5FgtGrRZ1je9eQpgCe8OPNTNe1cL1X//u.rwQ5YWQOaCcHV3RWi', TRUE),
       (100013, 'admin', '$2a$10$AFacJmhrZtuei1S/UJNwmOBASNbeVpNLR/taEzhSqD..x/LDYwllq', TRUE);

INSERT INTO user_roles(user_id, role)
VALUES (100030, 'STUDENT'),
       (100012, 'DISPATCHER'),
       (100013, 'ADMIN')